...
def detect_from_file(net, meta, file):
    im = load_image(file, 0, 0)
    return detect(net, meta, im)
...
if __name__ == "__main__":
    py = PlayerDetector()
    im = load_image( "data/football.jpg", 0, 0)
    r = py.detect_players(im)
    ...
    r = detect_from_file(net, meta, "data/football.jpg")
    print r
